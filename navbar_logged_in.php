		...
		<nav  class="navbar navbar-expand-md navbar-dark" style="background-color: #333;">       
		   <!-- Brand/logo -->
			...
			<a class="nav-item d-flex align-items-center ml-auto" style="color: white;margin-right:2%;">
					<a class="d-none d-sm-block" style="color: white;margin-right:2%;"><?php echo $_SESSION["username"] ?></a>
			</a>
			 <li class="nav-item dropdown d-none d-sm-block" id="dropdown_toggle">                 
				    <a class="nav-link dropdown-toggle hover_button" id="navbarDropdown" style="cursor: pointer;color:<?php echo $_SESSION["status_color"]?>!important;"role="button" data-toggle="dropdown" aria-expanded="false">&#9900 <?php echo $_SESSION["status"] ?></a>
					<div class="dropdown-menu dropdown-menu-right ml-auto " style="text-align: center; overflow:auto;min-width:8vw;max-width:8vw;" aria-labelledby="navbarDropdown">
						 <a class=" d-flex align-items-center ml-auto">
							<a class="dropdown-item d-none d-sm-block hover_menu_button" onclick="Status_Change()" style="cursor: pointer;color:<?php echo $_SESSION["status_color"]?>!important;margin-right:2%;">&#9900 <?php echo $_SESSION["status"] ?></a>
						</a>
