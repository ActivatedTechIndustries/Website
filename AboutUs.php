...
<body id="body1"  style="max-width:100%;overflow-x:hidden; background: rgb(27,35,45);background: -moz-linear-gradient(top, rgba(27,35,45,1) 64%, rgba(27,35,45,1) 85%);background: -webkit-linear-gradient(top, rgba(27,35,45,1) 64%,rgba(27,35,45,1) 85%);background: linear-gradient(to bottom, rgba(27,35,45,1) 64%,rgba(27,35,45,1) 85%);filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#1b232d', endColorstr='#1b232d',GradientType=0 );" onload="Page_View_Counter()">
		...
		<div class="container-fluid d-none d-md-block" style="height:128vh; margin-top:4%;overflow:hidden">
				<div class="row">
				...
				<div class="col-md-12 text-center">
						<hr style="background-color: rgba(1,168,183,1); width:95%; height:0.1vh; border-radius:50px;">
				<p style="color:white"> O Danilo fez tudo</p>
				</div>
				</div>
			</div>
			<div class="container-fluid d-sm-none" style="height:231vh; margin-top:4%;overflow:hidden">
				<div class="row">
					<div class="col-md-12" style="overflow:hidden">
							<h1 class="align-middle" style="color:#69E0DC;height:12vh;text-align:center; margin-top:2vh"> Os Grandes <hr style="background-color: white; width:25%; border-radius:50px;"> </h1>
				...
				<div class="row">
				<div class="col-md-12 text-center">
						<hr style="background-color: rgba(1,168,183,1); width:100vw; height:0.1vh; border-radius:50px;">
					  <p style="color:white"> O Danilo fez tudo</p>
				</div>
				</div>
			</div>
